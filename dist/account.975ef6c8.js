...
},{"./functions/_headerHeigth.js":"3VLQp","./functions/_fullHeigth.js":"3PSIv"}],"3VLQp":[function(require,module,exports) {
...
var _burgerJs = require("./components/_burger.js");

},{"./components/_select.js":"gAUBC","./components/_range.js":"fme75","./components/_copyBnt.js":"hfJfX","./components/_burger.js":"aATkn"}],"gAUBC":[function(require,module,exports) {
...
document[0, _configJs._querySelector](".referal__copy")?.addEventListener("click", (e)=>{
...
},{"../_config.js":"llBLd","../functions/_toggleClassItem":"ekfZO"}],"ekfZO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../_config":"llBLd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aATkn":[function(require,module,exports) {
var _configJs = require("../_config.js");
var _toggleClassItemJs = require("../functions/_toggleClassItem.js");
document[0, _configJs._querySelector](".burger")?.addEventListener("click", (e)=>{
    if (!e.target.matches(".burger")) return;
    (0, _toggleClassItemJs.toggleClassItem)(".page", "page--menu");
});
document[0, _configJs._querySelector]("span.nav__link")?.addEventListener("click", (e)=>{
    e.target.classList.toggle("nav__link--hover");
});

},{"../_config.js":"llBLd","../functions/_toggleClassItem.js":"ekfZO"}]},["ShInH","8lqZg"], "8lqZg", "parcelRequire46ec")
